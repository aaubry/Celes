(function () {
    ...
    tinymce.create('tinymce.plugins.CelesPlugin', {
        /**
        ...
        init: function (ed, url) {
            ...
            //    cm.setActive('celes', n.nodeName == 'IMG');
            //});
        },
        ...
        getInfo: function () {
            return {
                longname: 'Celes plugin',
                author: 'Antoine Aubry',
                authorurl: 'http://aaubry.net',
                infourl: 'https://github.com/aaubry/Celes',
                version: "1.0"
            };
        }
    });
    ...
    // Register plugin
    tinymce.PluginManager.add('celes', tinymce.plugins.CelesPlugin);
})();